...
exports.isOnboardingBranchConflicted = exports.setOnboardingConfigDetails = exports.getOnboardingConfigFromCache = exports.getOnboardingFileNameFromCache = exports.isOnboardingBranchModified = exports.hasOnboardingBranchChanged = exports.deleteOnboardingCache = exports.setOnboardingCache = void 0;
...
async function isOnboardingBranchModified(onboardingBranch) {
    const cache = (0, repository_1.getCache)();
    ...
    if (onboardingCache &&
        ...
        isModified = await scm_1.scm.isBranchModified(onboardingBranch);
    }
    return isModified;
}
