...
exports.addReleaseNotes = exports.releaseNotesCacheMinutes = exports.getReleaseNotesMd = exports.getReleaseNotesMdFile = exports.getReleaseNotesMdFileInner = exports.getReleaseNotes = exports.massageName = exports.massageBody = exports.getCachedReleaseList = exports.getReleaseList = void 0;
            ...
            for (const section of changelogParsed) {
                try {
                    ...
                    for (const word of title) {
                        if (word.includes(version) && !(0, url_1.validateUrl)(word)) {
                            ...
                            const mdHeadingLink = title
                                .filter((word) => !(0, url_1.validateUrl)(word))
                                .join('-')
