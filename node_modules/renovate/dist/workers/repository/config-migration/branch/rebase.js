...
async function rebaseMigrationBranch(config, migratedConfigData) {
    ...
    contents = await migrated_data_1.MigratedDataFactory.applyPrettierFormatting(migratedConfigData);
...
function jsonStripWhitespaces(json) {
     ...
     */
    return (0, stringify_1.quickStringify)(json5_1.default.parse(json)) ?? null;
}
