...
class PypiDatasource extends datasource_1.Datasource {
    ...
    async getDependency(packageName, hostUrl) {
        const lookupUrl = node_url_1.default.resolve(hostUrl, `${PypiDatasource.normalizeNameForUrlLookup(packageName)}/json`);
    ...
    async getSimpleDependency(packageName, hostUrl) {
        const lookupUrl = node_url_1.default.resolve(hostUrl, (0, url_1.ensureTrailingSlash)(PypiDatasource.normalizeNameForUrlLookup(packageName)));
        const dependency = { releases: [] };
