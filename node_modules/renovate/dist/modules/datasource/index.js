...
exports.getDefaultConfig = exports.getDigest = exports.supportsDigests = exports.getPkgReleases = exports.getDefaultVersioning = exports.getDatasourceFor = exports.getDatasourceList = exports.getDatasources = exports.isGetPkgReleasesConfig = void 0;
...
function getDefaultVersioning(datasourceName) {
    ...
    return datasource?.defaultVersioning ?? versioning_1.defaultVersioning.id;
}
...
function applyExtractVersion(config, releaseResult) {
...
function filterValidVersions(config, releaseResult) {
...
function sortAndRemoveDuplicates(config, releaseResult) {
    const versioningName = config.versioning ?? getDefaultVersioning(config.datasource);
    const versioning = allVersioning.get(versioningName);
...
function applyConstraintsFiltering(config, releaseResult) {
