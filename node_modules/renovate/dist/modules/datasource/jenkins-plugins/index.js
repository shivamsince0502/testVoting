...
class JenkinsPluginsDatasource extends datasource_1.Datasource {
    ...
    static packageInfoUrl = 'https://updates.jenkins.io/current/update-center.actual.json';
    static packageVersionsUrl = 'https://updates.jenkins.io/current/plugin-versions.json';
