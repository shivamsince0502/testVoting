...
async function updateArtifacts({ packageFileName, updatedDeps, newPackageFileContent, config, }) {
    ...
    try {
        ...
        const toolConstraints = [
            ...
            },
            {
                ...
                constraint: config.constraints?.helmfile ??
                    (0, utils_1.parseLock)(existingLockFileContent).version,
            },
        ];
        ...
        const cmd = [];
        const doc = (0, utils_1.parseDoc)(newPackageFileContent);
        for (const value of (0, array_1.coerceArray)(doc.repositories).filter(utils_1.isOCIRegistry)) {
            const loginCmd = (0, utils_1.generateRegistryLoginCmd)(value.name, `https://${value.url}`, 
