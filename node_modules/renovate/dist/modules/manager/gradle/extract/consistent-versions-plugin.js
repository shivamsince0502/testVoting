...
exports.parsePropsFile = exports.parseLockFile = exports.parseGcv = exports.isGcvLockFile = exports.isGcvPropsFile = exports.usesGcv = exports.VERSIONS_LOCK = exports.VERSIONS_PROPS = void 0;
...
const LOCKFILE_HEADER_TEXT = '# Run ./gradlew --write-locks to regenerate this file';
/**
...
function usesGcv(versionsPropsFilename, fileContents) {
    ...
    return (fileContents[versionsLockFile]?.startsWith(LOCKFILE_HEADER_TEXT) ?? false);
}
