...
function getAuthJson() {
    ...
    const selectedGithubToken = (0, utils_1.takePersonalAccessTokenIfPossible)((0, utils_1.isArtifactAuthEnabled)(githubHostRule)
        ? (0, utils_1.findGithubToken)(githubHostRule)
        : undefined, (0, utils_1.isArtifactAuthEnabled)(gitTagsHostRule)
        ? (0, utils_1.findGithubToken)(gitTagsHostRule)
        : undefined);
