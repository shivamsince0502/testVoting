...
exports.getConfiguredRegistries = exports.getDefaultRegistries = exports.readFileAsXmlDocument = void 0;
        ...
        if (child.type === 'element') {
            if (child.name === 'clear') {
                ...
                if (isHttpUrl) {
                    ...
                    logger_1.logger.debug(`Adding registry URL ${registryUrl}`);
                    registries.push({
                        name: child.attr.key,
                        url: registryUrl,
                    });
