...
function getSatisfyingVersion(versions, range) {
    ...
    const npmVersion = npm_1.api.getSatisfyingVersion(npmVersions, composer2npm(range));
    if (!npmVersion) {
        return null;
    }
...
function minSatisfyingVersion(versions, range) {
    const npmVersions = versions.map(composer2npm);
    const npmVersion = npm_1.api.minSatisfyingVersion(npmVersions, composer2npm(range));
    if (!npmVersion) {
        return null;
    }
    // get index of npmVersion in npmVersions
