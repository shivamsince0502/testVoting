...
exports.isUserBusy = exports.getMemberUserIDs = exports.getUserID = exports.gitlabApi = void 0;
...
async function getMemberUserIDs(group) {
    ...
    const members = (await exports.gitlabApi.getJson(`groups/${groupEncoded}/members`)).body;
