...
import type { AutodiscoverConfig, BranchStatusConfig, CreatePRConfig, EnsureCommentConfig, EnsureCommentRemovalConfig, EnsureIssueConfig, FindPRConfig, Issue, MergePRConfig, PlatformParams, PlatformResult, Pr, RepoParams, RepoResult, UpdatePrConfig } from '../types';
...
export declare function updatePr({ number: iid, prTitle, prBody: description, state, platformOptions, targetBranch, }: UpdatePrConfig): Promise<void>;
