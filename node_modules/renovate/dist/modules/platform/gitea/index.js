...
const platform = {
        ...
        try {
            const repos = await helper.searchRepos({
                ...
                ...(process.env.RENOVATE_X_AUTODISCOVER_REPO_SORT && {
                    sort: process.env.RENOVATE_X_AUTODISCOVER_REPO_SORT,
                }),
    ...
    async findPr({ branchName, prTitle: title, state = 'all', }) {
    ...
    async updatePr({ number, prTitle, prBody: body, state, targetBranch, }) {
        let title = prTitle;
