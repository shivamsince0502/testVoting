...
import type { BranchStatusConfig, CreatePRConfig, EnsureCommentConfig, EnsureCommentRemovalConfig, EnsureIssueConfig, EnsureIssueResult, FindPRConfig, Issue, MergePRConfig, PlatformParams, PlatformResult, RepoParams, RepoResult, UpdatePrConfig } from '../types';
...
export declare function initRepo({ endpoint, repository, forkOrg, forkToken, renovateUsername, cloneSubmodules, ignorePrAuthor, }: RepoParams): Promise<RepoResult>;
...
export declare function findPr({ branchName, prTitle, state, }: FindPRConfig): Promise<GhPr | null>;
...
export declare function createPr({ sourceBranch, targetBranch, prTitle: title, prBody: rawBody, labels, draftPR, platformOptions, }: CreatePRConfig): Promise<GhPr | null>;
export declare function updatePr({ number: prNo, prTitle: title, prBody: rawBody, state, targetBranch, }: UpdatePrConfig): Promise<void>;
