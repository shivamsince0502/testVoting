...
exports.ensureCommentRemoval = exports.reopenComments = exports.ensureComment = exports.REOPEN_PR_COMMENT_KEYWORD = void 0;
...
async function getComments(config, prNo) {
    const comments = (await bitbucketHttp.getJson(`/2.0/repositories/${config.repository}/pullrequests/${prNo}/comments`, {
        paginate: true,
    })).body.values;
