...
exports.queryReleases = exports.queryTags = void 0;
...
async function queryTags(config, http) {
    const res = await datasource_fetcher_1.GithubGraphqlDatasourceFetcher.query(config, http, tags_query_adapter_1.adapter);
    return res;
}
