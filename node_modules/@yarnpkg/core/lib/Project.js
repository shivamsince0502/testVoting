...
class Project {
    ...
    addWorkspace(workspace) {
        ...
        if (typeof dup !== `undefined`)
            throw new Error(`Duplicate workspace name ${structUtils.prettyIdent(this.configuration, workspace.locator)}: ${fslib_1.npath.fromPortablePath(workspace.cwd)} conflicts with ${fslib_1.npath.fromPortablePath(dup.cwd)}`);
