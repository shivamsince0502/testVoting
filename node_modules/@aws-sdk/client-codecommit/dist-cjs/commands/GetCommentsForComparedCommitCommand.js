...
exports.GetCommentsForComparedCommitCommand = exports.$Command = void 0;
...
class GetCommentsForComparedCommitCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetCommentsForComparedCommitCommand.getEndpointParameterInstructions()));
