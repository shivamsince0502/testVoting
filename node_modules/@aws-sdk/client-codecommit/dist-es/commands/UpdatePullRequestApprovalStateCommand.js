...
import { de_UpdatePullRequestApprovalStateCommand, se_UpdatePullRequestApprovalStateCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class UpdatePullRequestApprovalStateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdatePullRequestApprovalStateCommand.getEndpointParameterInstructions()));
