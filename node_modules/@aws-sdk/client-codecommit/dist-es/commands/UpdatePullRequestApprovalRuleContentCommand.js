...
import { de_UpdatePullRequestApprovalRuleContentCommand, se_UpdatePullRequestApprovalRuleContentCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class UpdatePullRequestApprovalRuleContentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdatePullRequestApprovalRuleContentCommand.getEndpointParameterInstructions()));
