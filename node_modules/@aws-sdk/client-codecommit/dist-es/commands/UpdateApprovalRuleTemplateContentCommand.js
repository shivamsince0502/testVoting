...
import { de_UpdateApprovalRuleTemplateContentCommand, se_UpdateApprovalRuleTemplateContentCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class UpdateApprovalRuleTemplateContentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateApprovalRuleTemplateContentCommand.getEndpointParameterInstructions()));
