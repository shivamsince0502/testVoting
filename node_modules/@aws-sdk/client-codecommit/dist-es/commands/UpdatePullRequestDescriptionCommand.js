...
import { de_UpdatePullRequestDescriptionCommand, se_UpdatePullRequestDescriptionCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class UpdatePullRequestDescriptionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdatePullRequestDescriptionCommand.getEndpointParameterInstructions()));
