...
import { de_UpdateApprovalRuleTemplateNameCommand, se_UpdateApprovalRuleTemplateNameCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class UpdateApprovalRuleTemplateNameCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateApprovalRuleTemplateNameCommand.getEndpointParameterInstructions()));
