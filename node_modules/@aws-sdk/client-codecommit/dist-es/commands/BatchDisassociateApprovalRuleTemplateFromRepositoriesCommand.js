...
export class BatchDisassociateApprovalRuleTemplateFromRepositoriesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, BatchDisassociateApprovalRuleTemplateFromRepositoriesCommand.getEndpointParameterInstructions()));
