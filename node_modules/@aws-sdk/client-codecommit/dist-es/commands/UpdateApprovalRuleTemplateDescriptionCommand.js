...
import { de_UpdateApprovalRuleTemplateDescriptionCommand, se_UpdateApprovalRuleTemplateDescriptionCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class UpdateApprovalRuleTemplateDescriptionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateApprovalRuleTemplateDescriptionCommand.getEndpointParameterInstructions()));
