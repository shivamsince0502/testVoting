...
public class AuthController {
    ...
    @Autowired
    public AsyncConfing asyncConfing;
    ...
    public void setHelper(JwtHelper helper) {
        this.helper = helper;
    }

    public void setAsyncConfing(AsyncConfing asyncConfing) {
        this.asyncConfing = asyncConfing;
    }
}
